        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row" style="padding-top: 40px;">
                    <div class="col-lg-12">
                        <h6><b><span style="float:right"><?php echo date_format(date_create($sheets['savedate']),'m/d/Y');  ?></span></b></h6>
                    </div>
                </div>
                ...
                <div class="row" style="padding-top:70px";>
                    <div class="col-lg-12">
                        <h6 style="padding-left: 60px;line-height: 0.5em">
                            <span><?php echo $sheets['driver_fname'];?></span> <span><?php echo $sheets['driver_lname'];?></span>
                                <span style="float:right;padding-right: 80px"><?php echo date_format(date_create($sheets['savedate']),'m/d/Y');  ?></span>
                        </h6>
